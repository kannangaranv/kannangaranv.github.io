...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Nuwan Kannangara
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className="home__subtitle">Undergraduate in Electronic and Telecommunication Engineering</h3>
        <p className="home__description">I am a motivated and detail-oriented professional passionate about cutting-edge technologies like Machine Learning, Computer Vision, Blockchain, and Software Development. With a strong foundation and hands-on experience, I aim to drive innovation and deliver impactful solutions in the tech industry.</p>
